...
// UserRegisterAction a plugin named "pagebreak".
CKEDITOR.plugins.add( 'pagebreak', {
	...
	init: function( editor ) {
		...
		// UserRegisterAction the command.
		editor.addCommand( 'pagebreak', CKEDITOR.plugins.pagebreakCmd );

		// UserRegisterAction the toolbar button.
	...
	afterInit: function( editor ) {
		...
		// UserRegisterAction a filter to displaying placeholders after mode change.
