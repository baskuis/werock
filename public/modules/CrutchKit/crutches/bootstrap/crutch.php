...
$CoreCrutchObject->setVersion('3.3.6.1');
$CoreCrutchObject->setFile('3.3.6/css/bootstrap.min.css');
 ...
 */
$CoreCrutchObject = new CoreCrutchObject();
$CoreCrutchObject->setVersion('3.3.6');
$CoreCrutchObject->setFile('3.3.6/js/bootstrap.min.js');
