...
$CoreCrutchObject->setVersion('1.2.5');
$CoreCrutchObject->setFile('1.2.5/ui-bootstrap-tpls-1.2.5.min.js');
...
$CoreCrutchObject->setDependencies(array('bootstrap', 'angularjs'));
