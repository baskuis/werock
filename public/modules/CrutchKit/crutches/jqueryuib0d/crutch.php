...
$CoreCrutchObject->setVersion('1.12.1');
$CoreCrutchObject->setFile('jquery-ui-1.12.1/jquery-ui.min.css');
...
$CoreCrutchObject = new CoreCrutchObject();
$CoreCrutchObject->setVersion('1.12.1');
$CoreCrutchObject->setFile('jquery-ui-1.12.1/jquery-ui.min.js');
