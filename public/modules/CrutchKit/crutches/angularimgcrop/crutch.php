...
$CoreCrutchObject->setVersion('0.3.2.1');
$CoreCrutchObject->setFile('0.3.2/ng-img-crop.js');
 ...
 */
$CoreCrutchObject = new CoreCrutchObject();
$CoreCrutchObject->setVersion('0.3.2');
$CoreCrutchObject->setFile('0.3.2/ng-img-crop.css');
