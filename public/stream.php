...
/**
 * Render Stream/Download response
 *
 * PHP version 5
 *
 * @package Ukora
...
try {
     ...
     * Route request
     */
    CoreInit::routeRequest(CoreControllerObject::GROUP_STREAM);

} catch(CoreSecurityApiException $e){
    CoreHeaders::add('status', 400);
} catch(Exception $e){
    CoreHeaders::add('status', 500);
}
